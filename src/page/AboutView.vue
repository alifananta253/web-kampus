        ...
        <div class="w-full md:w-1/2 p-4 rounded-3xl"  data-aos="fade-right">
          <div class="w-full self-center px-4 pb-4">
            <h1 class="text-base font-semibold text-dark md:text-xl mt-3">
              Haloo Guys,
              <p>Universitas Bina Sarana Informatika Keramat 98, yang terletak di akarta Pusat, merupakan sebuah Universitas yang berada di Jl. Kramat Raya No.98, RT.2/RW.9, Kwitang, Kec. Senen, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta, Indonesia.</p>
            </h1>
            <p
            ...
            <div class="px-4 flex items-center">
              <a
                href="https://www.instagram.com/kuliahbsiaja/"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/@KuliahBSIAja"
                target="_blank"
